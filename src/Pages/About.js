    ...
    return (
        ...
        <div>
            ...
            <Container>
                ...
                <Row className='mt-5'>
                    <Col lg={5} >
                        <img style={{ width: "35rem", height: "30rem" }} className="img-fluid my-5" src='https://images.pexels.com/photos/3680454/pexels-photo-3680454.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='img'></img>
                    </Col>
