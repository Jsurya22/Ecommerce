...
function Home() {
  ...
  const dispatch = useDispatch()
    ...
    return (
        ...
        <div>
            <Container className='hero__section'style={{backgroundColor:"#7CB9E8"}} >

                <Row >

                    <Col lg={6} md={12} style={{ marginTop: "8rem" }}>
                        <h1 className='title' style={{ width: "70%" }}>Make Your Interior More Minimalist & Modern</h1>
                        ...
                        <motion.button whileHover={{scale:1.1}} className='btn text-light py-2 px-4 mb-4' style={{ backgroundColor: "rgb(179, 122, 97)", fontSize: "17px" }}>
                        SHOP NOW
                          </motion.button>
                           </Link>
                    </Col>
                    ...
                    <img src='https://images.pexels.com/photos/1005058/pexels-photo-1005058.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt="" style={{width:"50%"}}/>
                    <img src='https://images.pexels.com/photos/2440471/pexels-photo-2440471.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt="" style={{width:"50%"}}/>
                    </div>
...
<div>
<section className='services__section pt-5'>
<Services/>
</section>
            ...
            <Container className='my-5 col-12 bg-dark px-5 py-5 '>
                ...
                <Link to="/Products" style={{textDecoration:"none"}} className="text-light" > 
                    <motion.button whileHover={{scale:1.1}} className=' btn text-light py-2 px-4' style={{ backgroundColor: "rgb(179, 122, 97)", fontSize: "15px" }}>ALL PRODUCTS</motion.button>
                    </Link>
                </div>
